...
INSERT KHACHHANG
VALUES 	(N'Đoàn Duy Thức', N'Hà Nội', N'Nam', '0359375927', 'mst0359375927'),
		(N'Dương Tuấn Thông', N'Nam Định', N'Nam', '0983957243', 'mst0359375927'),
		(N'Lê Thành Đạt', N'Phú Thọ', N'Nam', '0329385913', 'mst0359375927'),
		(N'Nguyễn Hằng Nga', N'Hà Nội', N'Nữ', '0918385728', 'mst0359375927'),
		(N'Trần Thanh Nga', N'Phú Thọ', N'Nữ', '0302947939', 'mst0359375927'),
		(N'Trần Trọng Hoàng', N'Hà Giang', N'Nam', '0304927493', 'mst0359375927'),
		(N'Nguyễn Mai Hoa', N'Hà Nội', N'Nữ', '0937294858', 'mst0359375927'),
		(N'Lê Thúy An', N'Hà Nội', N'Nam', '0389398214', 'mst0359375927') 
...
CREATE TABLE HOADON(
	...
	constraint RB_KhoaHD primary key (MaHD,MaKH,MaNVHT,MaMH)
	)
...
Alter Table HOADON
Add
Constraint HD3 foreign key (MaNVHT) References ACCOUNT(MaNVHT)
